...
export const BUSINESS_TYPE_TABLE = 'BUSINESS_TYPE_TABLE';
export const QR_MANAGEMENT_TABLE = 'QR_MANAGEMENT_TABLE';
export const MENU_MANAGEMENT_TABLE = 'MENU_MANAGEMENT_TABLE';
export const STAFF_MANAGEMENT_TABLE = 'STAFF_MANAGEMENT_TABLE';
export const ORDER_MANAGEMENT_TABLE = 'ORDER_MANAGEMENT_TABLE';
