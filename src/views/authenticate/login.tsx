import { FORGOT_PASSWORD } from '@/constains';
...
const Login = () => {
  ...
  return (
    <Card className="w-full h-full max-w-md mx-auto mt-12 px-2 sm:px-6">
      <CardHeader className="text-center">
        <Label className="text-2xl font-bold mb-4">{t('module.authentication.title')}</Label>
      </CardHeader>
