...
const CreateQR = () => {
  ...
  return (
    <div className="flex flex-col flex-1 lg:flex-row items-start justify-start w-full h-full">
      <Form {...form}>
      ...
      <div className="flex items-center justify-center w-1/4 h-full p-4 bg-blue-300">
