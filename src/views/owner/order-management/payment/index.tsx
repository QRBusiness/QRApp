...
const PaymentOrderPage = () => {
  ...
  return (
    <div className="min-h-screen  flex justify-center py-10 px-4">
      <div className="w-full max-w-3xl" ref={invoiceRef}>
        <Card className="p-8 shadow-lg">
          ...
          <div className="flex items-center justify-center gap-4 mt-8">
            ...
            <Button variant={'default'} onClick={() => checkoutOrder(id!)}>
              <CreditCard className="mr-2 size-4 md:size-5" /> Confirm Payment
            </Button>
          </div>
